...
<template>
    ...
    >
        ...
        <div class="flex justify-center">
            <NuxtImg
                v-if="
                currentDisplayPicture != undefined &&
        ...
        <div class="flex flex-row gap-3">
            <input type="file" id="imageinput" class="hidden" @change="onFileChange">
            <label for="imageinput" 
            class="flex w-full rounded-3xl border-solid border-2 border-[#A44646] text-[#a44646] bg-[#FFFFFF] 
